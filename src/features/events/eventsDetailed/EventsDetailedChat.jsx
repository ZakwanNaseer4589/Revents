...
import { listenToEventChat } from '../eventsAction';
import EventsDetailedChatForm from './EventsDetailedChatForm';
import {formatDistance} from 'date-fns';
import { Link } from 'react-router-dom';
import { CLEAR_COMMENTS } from '../eventsConstants';
import { createDataTree } from '../../../app/common/util/util';

export default function EventsDetailedChat({eventId}) {
...
{authenticated && 
<Segment attached>
    <EventsDetailedChatForm eventId={eventId} parentId={0} closeForm={setShowReplyForm} />
    <Comment.Group>
