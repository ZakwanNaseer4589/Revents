import { CLEAR_EVENTS, CLEAR_SELECTED_EVENTS, CREATE_EVENT, DELETE_EVENT, FETCH_EVENTS, LISTEN_TO_SELECTED_EVENTS, SET_FILTER, SET_START_DATE, UPDATE_EVENT } from "./eventsConstants";
import {asyncActionError, asyncActionFinish, asyncActionStart} from '../../app/async/asyncReducer';
import { LISTEN_TO_EVENT_CHAT } from "../profile/profileConstants";
...
export function fetchEvents(filter, startDate, limit, lastDocSnapshot){
    return async function(dispatch) {
        ...
        try{
            const snapshot = await fetchEventsFromFirestore(filter,
                startDate,
                limit,
                 lastDocSnapshot).get();
