...
// this handler is used in the on blur property to handel the value of longitude and latitude

    //   function handleBlur(e){
    //       field.onBlur(e);
    //       if (!field.value.latLng){
    //           helpers.setValue({address: 'null', latLng: null})
    //       }
    //   }
    ...
    {({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
        ...
        <input {...getInputProps({name: field.name, onBlur: field.onBlur, ...props})} />
